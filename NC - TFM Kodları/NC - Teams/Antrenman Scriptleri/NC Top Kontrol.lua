...
tfm.exec.setUIMapName("<VP>Orta Geliştirme <j>Devilstrkpro-Devilstrk")
...
tfm.exec.setUIMapName("<rose>Okul Mapı 2-Kurucu <j>Devilstrkpro-Devilstrk")
...
tfm.exec.setUIMapName("<rose>Top Kontrol Sahası-Kurucu <j>Devilstrkpro")
