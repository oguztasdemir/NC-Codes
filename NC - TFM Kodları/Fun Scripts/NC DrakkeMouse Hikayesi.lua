...
story = {
	...
	{"Merhaba, benim adım ARCHAIN Von Drekkemaus.", "<a href='event:nextQu2'>> Merhaba</a>"}, -- 1 Général +0

	{"Sonunda seninle tanışmak!", "<a href='event:nextQu3'>>Seni görmek güzel!</a>", "<a href='event:nextQu6'>> Korkarım...</a>"}, -- 2 Général +0

	{"Hatta ben size zarar veremez olur?", "<a href='event:nextQu4'>> Evet!</a>", "<a href='event:nextQu5'>> Demek istediğim bu değil:(</a>"}, -- 3 Situationnel[2.1] +0

	{"Sen benim tatmak için kendinize biraz çok emin görünüyorsun. ò.ó", "<a href='event:nextQu7'>-Aşağıdaki-</a>"}, -- 4 Situationnel[3.1] +0

	{"Senin için umut !!! ò.ó", "<a href='event:nextQu7'>-Aşağıdaki-</a>"}, -- 5 Situationnel[3.2] +1

	{"Benden kormak için haklısın. ò.ó", "<a href='event:nextQu7'>-Aşağıdaki-</a>"}, -- 6 Situationnel[2.2] +2

	{"Hakkımda ne biliyorsun?", "<a href='event:nextQu8'>> Çok değil</a>", "<a href='event:nextQu9'>> Her şey !</a>"}, -- 7 Général +0

	{"Daha sonra beni tanımak için gidiyoruz.", "<a href='event:nextQu12'>-Aşağıdaki-</a>"}, -- 8 Situationnel[7.1] +1

	{"Ne gibi ?", "<a href='event:nextQu10'>> Bir fare vampir sensin</a>", "<a href='event:nextQu11'>> Sen ısırık sevmiyorsun.</a>"}, -- 9 Situationnel[7.2] +0

  {"En önemlisi kötü ò.ó", "<a href='event:nextQu12'>-Aşağıdaki-</a>"}, -- 10 Situationnel[9.1] +2

	{"Ben ısırmaya istemiyorsanız göreceksiniz!", "<a href='event:nextQu12'>-Aşağıdaki-</a>"}, -- 11 Situationnel[9.2] -1

	{"Bence gibi, benim başlığı Von Drekkemaus var?", "<a href='event:nextQu13'>> Sana değil avous...</a>", "<a href='event:nextQu16'>> Tabiki evet!</a>"}, -- 12 Général +0

	{"Bu oyunun sadece en iyi başlık eksikliği, tamam.", "<a href='event:nextQu14'>> Her şey.</a>", "<a href='event:nextQu15'>> Biliyorum...</a>"}, -- 13 Situationnel[12.1] +0

	{"Bana ters cesaret... Dikkat et!", "<a href='event:nextQu19'>-Aşağıdaki-</a>"}, -- 14 Situationnel[13.1] +0

	{"Sen samimi görünmüyorsun...", "<a href='event:nextQu19'>-Aşağıdaki-</a>"}, -- 15 Situationnel[13.2] -1

	{"Ben ('yukarıdan fareyi Yenile Eğer doğrulayarak önce değişmiş kısa sürede sol tıklayın) [/ başlık 307] etsinler ...", "<a href='event:nextQu17'>-Aşağıdaki-</a>"}, -- 16 Situationnel[12.2] +0

	{"Tamam, bu konuda, herkes size saygı duyacağız.", "<a href='event:nextQu19'>-Aşağıdaki-</a>"}, -- 17 Situationnel[16.0] +2

	{"Beni LIED var ve ben bunu sevmiyorum gibi görünüyor! ò.ó", "<a href='event:nextQu19'>-Aşağıdaki-</a>"}, -- 18 Situationnel[16.0] -1

	{"Değilse, hiç benim kedi iskeleti dövmek mi?", "<a href='event:nextQu21'>> Birçok kez evet</a>", "<a href='event:nextQu20'>> Hayır, daha önce bayılttı</a>"}, -- 19 Général +0

	{"Ben mankenlerden nefret ediyorum!", "<a href='event:nextQu24'>-Aşağıdaki-</a>"}, -- 20 Situationnel[19.2] -1

	{"O yüz mor muydu?", "<a href='event:nextQu22'>> Zaten biraz</a>", "<a href='event:nextQu23'>> Bu küçük Chihuahua?</a>"}, -- 21 Situationnel[19.2] +0

	{"Benim yaratılış orada başlamak!", "<a href='event:nextQu24'>-Aşağıdaki-</a>"}, -- 22 Situationnel[21.1] +1

	{"Benim bekçi için biraz saygı, ben sana dua ederim!", "<a href='event:nextQu24'>-Aşağıdaki-</a>"}, -- 23 Situationnel[21.2] +0

	{"Şimdi benim için vampir dişlerini karşılaştırabilirsiniz olacak?", "<a href='event:nextQu25'>> Evet hemen</a>", "<a href='event:nextQu28'>> Hayır,o olacak</a>"}, -- 24 Général +0

	{"Ekipman şimdi vampir dişlerinin! (En kısa sürede size doğrulayarak önce değişmiş olarak sol üstten fare Yenile 'üzerine tıklayın)", "<a href='event:nextQu26'>-Aşağıdaki-</a>"}, -- 25 Situationnel[24.1] +0

	{"Anlaşılan, onlar size daha bana çok daha iyi! Gülünç muahaha görünüyorsun ò.ó", "<a href='event:nextQu31'>-Aşağıdaki-</a>"}, -- 27 Situationnel[25.0] +0

	{"Bunları yapmadığınız gibi görünüyor. Neyse ki, kendini bana karşılaştırmak olamaz ò.ó", "<a href='event:nextQu31'>-Aşağıdaki-</a>"}, -- 26 Situationnel[25.0] +1

	{"Neden onun vampir dişlerini gösteriyor değil mi?", "<a href='event:nextQu29'>> Ben istemiyorum çünkü</a>", "<a href='event:nextQu30'>> Ben yapmadım çünkü...</a>"}, -- 28 Situationnel[24.2] +0

	{"Sen bana onu yapacak, haklısın ò.ó", "<a href='event:nextQu31'>-Aşağıdaki-</a>"}, -- 29 Situationnel[28.1] +2

	{"Bu durumda Halloween katılmak nasıl ...", "<a href='event:nextQu31'>-Aşağıdaki-</a>"}, -- 30 Situationnel[28.2] +0

	{"Sen sevdiğim kadının adını hatırlıyor musun?", "<a href='event:nextQu32'>>Evet, onun adı Luffy olduğunu hatırlıyorum.</a>", "<a href='event:nextQu33'>> Ben onun adı Buffy olduğuna inanıyorum.</a>"}, -- 31 Général +0

	{"Sen iyi bir hafıza bunu söylemek yok. Buffy oldu! ò.ó", "<a href='event:nextQu34'>-Aşağıdaki-</a>"}, -- 32 Situationnel[31.1] -1

	{"İşte bu: Buffy sevgilim!", "<a href='event:nextQu34'>-Aşağıdaki-</a>"},  -- 33 Situationnel[31.2] +1

	{"Bir aşık önce, o bir iş vardı. Size göre hangisi?", "<a href='event:nextQu35'>> Vampir avcısı</a>", "<a href='event:nextQu36'>> Korumalı vampir.</a>"},  -- 34 Général +0

	{"Evet beni mutlu olabilecek bir iş değildi.", "<a href='event:nextQu37'>-Aşağıdaki-</a>"}, -- 35 Situationnel[34.1] +1

	{"Güzel iş olurdu ama ne...", "<a href='event:nextQu37'>-Aşağıdaki-</a>"},  -- 36 Situationnel[34.2] +2

	{"Burada, size oldukça kesin olup olmadığını bilmek için zamanı geldi", "<a href='event:nextQu38'>-Aşağıdaki-</a>"}, -- 37 Général +0

	{"Benim evime alabilir miyim?", "<a href='event:nextQu39'>Ben öyle düşünüyorum! </a>", "<a href='event:nextQu39'>Bilmiyorum ...</a>"}, -- 38 Général +0

	{"(10 veya daha fazla puan 15 takım olmalıdır) en topladığınız puan bakalım !!!", "<a href='event:nextQu40'>-Aşağıdaki-</a>"} -- 39 Général +0
