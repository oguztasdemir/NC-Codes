...
function pw(name)
print("<font color='#ffffff'> The tribe house's password has been activated")
...
ui.addTextArea(4, "\n<p align='center'><font color='#babd2f' size='25' face='Comic Sans MS'><b>The tribe house is closed with a password</b>\n\n<p align='center'><font color='#babd2f' size='25' face='Comic Sans MS'>Enter the password here", name, 11, 34, 777, 355, 0x523d25, 0xc4621c, 1, true)
