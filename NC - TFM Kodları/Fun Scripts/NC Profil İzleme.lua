...
ui.addTextArea(3, "<r>"..p[name].kisi.." <br><br><bv>Peynir = <j>"..prf[p[name].kisi].pey.." <vp><font size='10'><br><a href='event:hkreset'>Hakkımda Reset</a><br><r><a href='event:models'>Model</a> = <vp>"..prf[p[name].kisi].model.." </a><br><br><br><a href='event:kpt'><r><font size='15'>[Kapat]", name, 343, 131, 241, 121, 0x1, 0x1, 1, true)
...
ui.addTextArea(5, "<vp><a href='event:hkreset'>Hakkımda Reset</a><br><r><a href='event:models'>Model</a> = <vp>"..prf[p[name].kisi].model.."", name, 660, 200, 100, 34, 0x151717, 0x0, 0.7, true)
end
end
end
...
ui.addTextArea(3,"İsim Yukleniyor.. <br><br>İstatikler Yukleniyor...<br><br><a href='event:kpt'><r>[Durdur]",name,400,200,100,nil,0x1,0x1,1,true)
...
if cb=="about" then
ui.addPopup(1,2,"Hakkımda Duzenle", name, 160, 100, nil, true)
end
if cb=="profilim" then
p[name]={kisi=""..name..""}
ui.addTextArea(3,"İsim Yukleniyor.. <br><br>İstatikler Yukleniyor...<br><br><a href='event:kpt'><r>[Durdur]",name,400,200,100,nil,0x1,0x1,1,true)
