...
couple = {"Devilstrkpro#5475", "Atistiz"},
...
announcement("<p align='center'><font size='18'>"..n.." Yemek salonuna gelirken öldüğünden dolayı düğün iptal edilmiştir.")
...
announcement("<p align='center'><font size='18'>"..n.." Yemeğe gelmediğinden dolayı düğün iptal edilmiştir.")

break

else

announcement("<p align='center'><font size='24'>Yemek başlamıştır! :) İyi Eğlenceler!")
...
tfm.exec.setUIMapName("Sevgili Restorant) <G>| <N>Zıkkımlananlar : <V>"..settings.couple[1].." <BL>- <V>"..settings.couple[2])
...
text = "<p align='center'><font size='22'>Yemeğin başlamasına <V>"..t.." <N>saniye kaldı."
...
{"Merhaba, sayın "..n[1]..". Hoşgeldiniz", "Hanımefendi Ne isterler :)", "Hoşbulduk"},

{"Siz de hoş geldiniz, sayın "..n[2]..".", "Yemeği söyleyebilirmiyiz ?", "Hoş bulduk."},

{"Bugün "..n[1].." ve "..n[2].."'nin Yemeği için burdayız", "Ben Tavuk ve Ice Tea almak istiyorum", "Ben hanımefendi ne isterse onu istiyorum."},

{"Bugün "..n[1].." ve "..n[2].."'yi evlendirmek için buradayız.", "Ben Tavuk ve Ice Tea almak istiyorum", "Teşekkür ederiz."},

{"Sayın "..n[1]..", "..n[2].." Yemeğinizi Beğendinizmi ?", "Evet!", "Meleğim Beğendiyse benim için sorun yok."},

{"Peki siz, sayın "..n[2]..", "..n[1].." Yemeğinizi Beğendinizmi ?", "Evet!", "Mükemmel Olmuş."},

{"Melek Restoranttan yediğiniz için teşekkür ederiz.", "Hoşçakalın", "Güle Güle"},

{"Melek Restoranttan yediğiniz için teşekkür ederiz.", "Hoşçakalın", "Bay bay"},
