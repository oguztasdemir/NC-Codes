...
function pw(name)
print("<font color='#ffffff'> Kabile evi şifrelendirmesi aktifleştirildi.")
...
ui.addTextArea(4, "\n<p align='center'><font color='#babd2f' size='25' face='Comic Sans MS'><b>Tüm oyun içi bilgilendirme, bu bir test mesajıdır. Devam etmek için şifrenizi girebilirsiniz. </b>\n\n<p align='center'><font color='#babd2f' size='25' face='Comic Sans MS'>Lütfen aktivasyon şifresini girin.</b>\n\n<p align='center'><font color='#babd2f' size='25' face='Comic Sans MS'>İpucu: Hesabınıza giriş yapmalısınız!", name, 11, 34, 777, 355, 0x523d25, 0xc4621c, 1, true)
...
ui.addPopup(0, 2, "<p align='center'> Şifre girme ekranı:", name, 296, 305, 217, true)
end
end
end
