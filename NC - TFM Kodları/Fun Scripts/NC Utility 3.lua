...
function eventPlayerWon(name)
   ...
   x=x+1
      ...
      feed.text=""..feed.text.."<font color='#6D4A2D'>"..x..".</font><font color='#F0C019'>"..name.." </font><font color='#ffffff'>kazandı! <br>"
...
function eventPlayerLeft(name)
   ...
   x=x+1
      ...
      feed.text=""..feed.text.."<font color='#6D4A2D'>"..x..".</font><font color='#4EB84A'>"..name.." </font><font color='#ffffff'>odadan çıktı! <br>"
...
function eventPlayerRespawn(name)
   ...
   x=x+1
      ...
      feed.text=""..feed.text.."<font color='#6D4A2D'>"..x..".</font><font color='#326EE9'>"..name.." </font><font color='#ffffff'>tekrar doğdu! <br>"
...
function eventPlayerGetCheese(name)
   ...
   x=x+1
      ...
      feed.text=""..feed.text.."<font color='#6D4A2D'>"..x..".</font><font color='#8080FF'>"..name.." </font><font color='#ffffff'>peyniri aldı! <br>"
