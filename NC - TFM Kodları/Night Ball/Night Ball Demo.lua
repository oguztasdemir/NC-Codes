...
local admin = {["Devilstrkpro#5475"] = true, Pie = true, ["Devilstrk#5475"] = true}
...
textSB = {
  ...
  help = "<p align='center'><font size='18'><b><u>Night Ball</u></b></font></p><br><u><b>Oyun Hakkında</b></u><br>Bu oyun Devilstrkpro ve Devilstrk tarafından kodlanmıştır. Kod Night Club Seri'sine özel bir koddur. Oynamak isteyenler Devilstrkpro'ya söyleyebilir.<br><br><u><b>Oyun Nasıl Oynanır?</b></u><br>Oyun kırmızı ve mavi takım olmak üzere iki takımdan oluşur. Takımlar oyun tarafından otomatik seçilir.Oyunun gol atmaktır.Ard arda zıplamaya basınca fare uçar, aşaya basılı tutup çekince faremiz yere hızla iner.Oyun süresi 5 dakikadır.<b> <br><br><u><b>Oyun Komutları:</b></u><br>•<b> !controls or C</b> kontrol sayfasını açar.<br>•<b> !particles or P</b> (Üstünde çalışılıyor.Şuan bir şey yapamamaktır.)<br>•<b> !mort</b> faremizi öldürür.<br>•<b> !playtime</b> oyun süresini ayarlar.<br>•<b> !commands or H</b> Komut sayfasını açar.(Admin komutlarını sadece oyun kurucuları yapabilmektiedir.)<br><br><b><u>Admin Komutları:</u></b><br>•<b> !admin name</b> oyun bitene kadar adı seçilen oyuncuyu admin yapar.<br>•<b> !announce text</b> tüm odanın görebildiği bir yazı çıkarır.<br>•<b> !ban/unban name</b> adı yazılan oyuncuyu banlar veya banlanmış bir oyuncucu banını kaldırır.<br>•<b> !kill name</b> adı yazılan oyuncuyu öldürür.<br>•<b> !reload</b> oyunu tekrardan açar.<br>•<b> !ball</b> 15 saniye içinde yeni top yaratır.<br>•<b> !time num</b> oyunu bozar.<br>•<b> !red/blue name</b> adı yazılan oyuncuyu kırmızı veya mavi takıma gönderir.<br>•<b> !spec name</b> adı yazılan oyuncuyu izleyi moduna çevirir<br>•<b> !lock/unlock</b> odaya şifre koyar veya şifreyi kaldırır<br>•<b> !overtime</b> Süreyi 5 saniyeye indirir.<br><br><br>";

  commands = "<b><p align='center'><font size='18'><u>Admin Komutları</u></font></p></b><br>•<b> !admin name</b> to make the selected player admin.<br>•<b> !announce text</b> to display text to everyone.<br>•<b> !ban/unban name</b> to ban or unban the selected player.<br>•<b> !kill name</b> to kill the selected player.<br>•<b> !reload</b> This will reload the map.<br>•<b> !ball</b> to spawn another ball if no ball appears after 15 seconds.<br>•<b> !time num</b> to set the time to num.<br>•<b> !red/blue name</b> to set the name's team to red or blue.<br>•<b> !spec name</b> to enable or disable spectator mode for the selected player.<br>•<b> !lock/unlock</b> odaya şifre koyar veya şifresi kaldırır.<br>•<b> !force num</b> to set a new boost multipler. The default is 1, and the max is 4.<br>•<b> !overtime</b> to manually start overtime mode.<br><br><br>";
  ...
  Join = function(team, n)
    ...
    if players[n] then
      ...
      if team == red then
        ...
        ui.addBotText("<VP>"..n.."<N> kırmızı takıma katıldl!", nil)
...
function updateScore()
  ...
  tfm.exec.setUIMapName("<j>NİGHT BALL <bl>- NC'YE ÖZEL MAP<g>   |   <N>Red : <V>"..score.red.."<g>   |   <N>Blue : <V>"..score.blue)
  ...
  if left < 5 then
    ...
    elseif gameStart then
      ...
      elseif overTime then
        ...
        announceText("Maç berabere bitti! İlk golü atan maçı kazanır!", 30)
  ...
  ui.addBotText("The <VP>"..scorer.."<N> team has scored!", nil)
    ...
    if ballCount == 0 then
      ...
      if overTime then
        ...
        announceText("İNANILMAZZZZ! "..scorer.." takım golü attı.<br>Maç bitti.", 28)
...
function eventPlayerLeft(n)
  ...
  if red[n] then
    ...
    ui.addBotText(n.." Oyunu ve kırmızı takımı bıraktı. Kırmızı takımda şuan 1 kişi eksik bulunuyor!", nil)

  elseif blue[n] then

    ui.addBotText(n.." Oyunu ve mavi takımı bıraktı. Mavi takımda şuan  1 kişi eksik bulunuyor!", nil)
...
function eventChatCommand(n, cmd)
  ...
  if admin[n] then
    ...
    elseif arg[1] == "ban" and arg[2] then
      ...
      ui.addBotText("<VP>"..pn.."<N> banlanıldı", n)
    ...
    elseif cmd == "overtime" then
      ...
      ui.addBotText("Ek zaman birazdan başlayacak.", nil)
  ...
  if players[n] then
    ...
    if cmd == "mort" or cmd == "afk" then
      ...
      if not spectators[n] then
        ...
        ui.addBotText("Sen şuan izleyici moddasın.Sadece maçı izleyebilirsin.", n)
