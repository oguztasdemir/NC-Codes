...
function eventTextAreaCallback(id, n, cb)
  ...
  if cb == "soupBot" then
    ui.addTextArea(101, "Ne Yapmak �stiyorsun? <b><a href='event:bot_controls'>Change ducking controls</a></b>, <b><a href='event:bot_particles'>customize your particles</a></b>, or <b><a href='event:bot_nothing'>nothing?", n, 6, 355, nil, 30, 0x324650, 0x89A7F5, 0.7, true)
  end
  ...
  if admin[n] then
    ...
    elseif arg[1] == "force" then
      if arg[2] then
        ...
        globalBoostForce = 1
        ui.addBotText("Boostun varsayılan olarak ayarland�.", n)
      end
    ...
    elseif cmd == "reload" or cmd == "skip" then
      ...
      ui.addBotText("Oyun birkaç saniye sonra ba�layacakt�r.", nil)
      gameStart = false
      overTime = false
    ...
    elseif arg[1] == "spec" then
      if arg[2] then
        ...
        if spectators[pn] then
          spectators[pn] = false
          ui.addBotText("Art�k izleyici de�ilsin!", pn)
          ...
          blue[pn] = false
          tfm.exec.killPlayer(pn)
          ui.addBotText("Art�k izleyicisin.", pn)
    ...
    elseif arg[1] == "admin" and arg[2] then
      ...
      ui.addBotText("Art�k adminsin.", pn)
 ...
 ui.addBotText("<VP>"..pn.."<N> artık admin değil!", n)
  ...
  if players[n] then
    ...
    elseif cmd == "playtime" then
      ui.addBotText("Maçın bitimine kalan süre <VP>"..playTime.."<N> olarak ayarland�!", n)
