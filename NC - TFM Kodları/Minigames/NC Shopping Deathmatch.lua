...
ui.addTextArea(81, "<font color='#32FF00'>Profil Düzgün Çalışıyor / M.E D.M /", name, 8, 28, 209, 22, 0x1, 0x1, 0.6, true)

ui.addTextArea(82, "<font color='#32FF00'>X Y Sıfırlanma Basarılı / M.E D.M /", name, 368, 66, 206, 23, 0x1, 0x1, 0.6, true)

ui.addTextArea(83, "<font color='#32FF00'>Default Drag Gecis / M.E D.M /", name, 589, 66, 206, 23, 0x1, 0x1, 0.6, true)

ui.addTextArea(84, "<font color='#32FF00'>Drag Sistemi Düzgün Çalışıyor / M.E D.M /", name, 235, 29, 256, 23, 0x1, 0x1, 0.6, true)
...
ui.addTextArea(0, "<i><v><font size='30'><p align='center'>"..args[2].."</v></p><font size='12'><n> Ayarlar<br> <g>• Offset X : <v>"..players[args[2]].offsets.x.."<br> <g>• Offset y : <v>"..players[args[2]].offsets.y.."<br> <g>• Drag Numarası : <j>"..players[args[2]].dragt.."<br><N>Eventler<br><g>• Ölüm:<j> "..players[args[2]].death.."<br><g>• XP: <j>"..players[args[2]].kazanma.."/65<br><g>• Atılan Draglar:<j> "..players[args[2]].drag.."<br><g>• Turlar :<j> "..players[args[2]].rounds.."<br><g>• Rank:<j> "..players[args[2]].pro.."<br><n>Arena<br><g>• Survivor:<j> "..players[args[2]].surv.."<br><g>• Kazanmalar:<j> "..players[args[2]].arnkzn.."<br><g>• Turlar:<j> "..players[args[2]].arntur.."<br><n>Takım<br><g>• Kazanma:<j> 0<br><g>• Turlar:<j> 0<br><v>Para: <j>"..players[args[2]].para.." <v>TL", name, 288, 49, 281, 297, 0x324650, 0x324650,1,true)
...
tfm.exec.chatMessage("Yerler Değiştirildi X:"..players[name].offsets.x.." Y:"..players[name].offsets.y,name)
...
ui.addTextArea(0, "<i><v><font size='30'><p align='center'>"..name.."</v></p><font size='12'><n> Ayarlar<br> <g>• Offset X : <v>"..players[name].offsets.x.." <j><a href='event:plusX'>[+]</a> <a href='event:lessX'>[-]</a><br> <g>• Offset y : <v>"..players[name].offsets.y.." <j><a href='event:plusY'>[+]</a> <a href='event:lessY'>[-]</a><g> <a href='event:offsetsfabrika'>Fabrika Ayarları</a><br> <g>• Drag Numarası : <j>"..players[name].dragt.." <a href='event:draglarim'>Draglar</a><br><N>Eventler<br><g>• Ölüm:<j> "..players[name].death.."<br><g>• XP: <j>"..players[name].kazanma.."/65<br><g>• Atılan Draglar:<j> "..players[name].drag.."<br><g>• Turlar :<j> "..players[name].rounds.."<br><g>• Rank:<j> "..players[name].pro.."<br><n>Arena<br><g>• Survivor:<j> "..players[name].surv.."<br><g>• Kazanmalar:<j> "..players[name].arnkzn.."<br><g>• Turlar:<j> "..players[name].arntur.."<br><n>Takım<br><g>• Kazanma:<j> 0<br><g>• Turlar:<j> 0<br><v>Paran: <j>"..players[name].para.." <v>TL", name, 288, 49, 281, 297, 0x324650, 0x324650,1,true)
...
ui.addTextArea(12421, "<a href='event:levelatla'><r>Level<br><a href='event:parag'>Para<br><a href='event:objdegs'>Dragları Aç<br><a href='event:mapgec'>Map Geç", name, 543, 62, 77, nil, 0x283135, 0x283135, 0.6, true)
...
ui.addPopup(3,2,"<p align='center'>Dragları Ver",name,200,130,400,true)
...
ui.addTextArea(99999999999999, "<p align='center'><font size='15'><v><b>Draglarım", name, 247, 153, 334, 26, 0x101112, 0x1, 0.8, true)
...
ui.addTextArea(100000000000000, "<bv>Şaman Dragı -<r><a href='event:shmdraguse'> Use", name, 258, 198, 120, 27, 0x101112, 0x1,1,true)

end

for name in pairs(drag3) do

ui.addTextArea(100000000000002, "<bv>Elma Dragı -<r><a href='event:elmadraguse'> Use", name, 452, 197, 120, 27, 0x101112, 0x1,1,true)

end

for name in pairs(drag2) do

ui.addTextArea(100000000000003, "<bv>Mum Dragı -<r><a href='event:mumdraguse'> Use", name, 260, 255, 120, 27, 0x101112, 0x1,1,true)

end

for name in pairs(drag4) do

ui.addTextArea(100000000000004, "<bv>Cam Dragı -<r><a href='event:camdraguse'> Use", name, 452, 256, 120, 27, 0x101112, 0x1, 1, true)
...
ui.addTextArea(100000000000006, "<bv>Şeker Drag -<r><a href='event:sekerdraguse'> Use", name, 465, 305, 110, 27, 0x101112, 0x1, 1, true)
...
ui.addTextArea(12341, "<b><font size='20'><V><p align='center'>Market</p><j><font size='7'>Paranız <v>"..players[name].para.."<br><n><font size='10'><j>Default Drag <r>[<bv><a href='event:defaultdrag'>Kullan</a><r>] <g>Fiyat = 0<br><n><font size='10'><j>Şaman Dragı <r>[<bv><a href='event:meep'>Satın Al</a><r>] <g>Fiyat = 120<br><n><font size='10'><j>Elma Dragı <r>[<bv><a href='event:elmadrag'>Satın Al</a><r>] <g>Fiyat = 30<br><n><font size='10'><j>Mum Drag <r>[<bv><a href='event:mumdrag'>Satın Al</a><r>] <g>Fiyat = 5<br><n><font size='10'><j>Cam Drag <r>[<bv><a href='event:camdrag'>Satın Al</a><r>] <g>Fiyat = 200<br><n><font size='10'><j>Gorunmez Drag <r>[<bv><a href='event:ghostdrag'>Satın Al</a><r>] <g>Fiyat = 1500<br><n><font size='10'><j>Şeker Drag <r>[<bv><a href='event:sekerdrag'>Satın Al</a><r>] <g>Fiyat = 1000<br><n><font size='10'><j>Karpuz Drag <r>[<bv><a href='event:karpuzdrag'>Satın Al</a><r>] <g>Fiyat = 2000", name, 6, 26, 323, 182, 0x272a2c, 0x0, 0.9,true)
