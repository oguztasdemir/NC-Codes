...
map={"@3531599","@6777390","@6916197","@6916167","@4867356","@7168031","@7064254","@6712801","@7010729","@6888882","@6868819","@6821000","@6730002","@5751542","@6863706","@6438348","@6776021","@7057301"}
...
tfm.exec.setUIMapName("<r>#<j><VP>Night Club Pealse")
zaman=120
ebem = {}
...
if zaman==115 then
ui.addTextArea(3, "<font size='35'><p align='center'><vp><b>Baþla !", nil, 350, 58, 00, 00, 0x1, 0x1, 0.7, true)
end
if zaman==116 then
ui.addTextArea(3, "<font size='35'><p align='center'><vp><b>1", nil, 350, 58, 00, 00, 0x1, 0x1, 0.7, true)
end
if zaman==117 then
ui.addTextArea(3, "<font size='35'><p align='center'><r><vp>2", nil, 350, 58, 00, 00, 0x1, 0x1, 0.7, true)
end
if zaman==118 then
ui.addTextArea(3, "<font size='35'><p align='center'><r><vp>3", nil, 350, 58, 00, 00, 0x1, 0x1, 0.7, true)
end
if zaman==119 then
ui.addTextArea(3, "<font size='35'><p align='center'><r><vp>4", nil, 350, 58, 00, 00, 0x1, 0x1, 0.7, true)
end
if zaman==120 then
ui.addTextArea(3, "<font size='35'><p align='center'><r><vp>5", nil, 350, 58, 00, 00, 0x1, 0x1, 0.7, true)
end
zaman=zaman-0.5
if zaman>=5 then
tfm.exec.setGameTime(zaman)
end
ui.addTextArea(1,"<r><b>[Ebe]<v> "..ebe.." <b><vp>"..math.floor(timer).."",nil,tfm.get.room.playerList[ebe].x20,tfm.get.room.playerList[ebe].y50,nil,nil,0x1,0x1,0.6)
if timer<=0 then
