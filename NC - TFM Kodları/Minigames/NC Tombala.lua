...
system.bindMouse("Devilstrkpro#5475")
...
ui.addTextArea(17, "<font size='20'><b><r><p align='center'>[<vp>"..gelcek.."<r>]<br><v><font size='13'>"..name.."<bv> Aldı !", nil, 590, 36, 164, 57, 0x1, 0x1, 0.4, true)
...
ui.addTextArea(19, "<p align='center'><font size='15'><j><b>"..kazananism.." <r>Kazandı !", nil, tfm.get.room.playerList[kazananism].x-60, tfm.get.room.playerList[kazananism].y-70, nil, nil, 0x1, 0x1, 0.6)
