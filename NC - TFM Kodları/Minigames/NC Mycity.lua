...
randombalikis={"Hint : Spaceye Basarsan Balık Tutarsın<br>Press The Space button Fish catch"}

randommadenis={"Hint : Yanıma gelip e ye basarsan Kazma İşlemi Başlar<br>The when the comes and Press E start"}
...
nothave1="Kazman Yok Kazma Almalısın !",

nothave2="Oltan Yok Olta Almalısın",
...
oltakirik="Oltan Kırıldı !",

comingsoon="Yakında...",

kazmafull="Tane Kazman oldu Daha fazla alamazsın !",

oltafull="Tane Oltan oldu Daha fazla alamazsın !",

fishermsg1="Oltanın ucu Boş ! :/",

fishermsg2="Hamsi Yakaladın 30 Lira Eder !",

fishermsg3="Levrek Yakaladın 35 Lira Eder !",

fishermsg4="Çinekop Yakaladın 50 Lira Eder !",

fishermsg5="Eski Para Oltana Takıldı 75 Lira Eder !",

fishermsg6="Köpek Balıgı Yakaladın 90 Lira Eder !",

help="<p align='center'><b>Yardım<br>• İş : Balıkçılık : Balıkçılıkta 30 TL 90 TL arası para kazanırsınız 1 oltanın 4 kullanım hakkı vardır.<br>• İş : Madencilik : Her maden kazarken 1 Kazmaya İhteyacınız vardır bunuda zaten madenci iş tagının altında alabilirsiniz.<br>• Envanter : 1. Olan Kazmadır 2. Olan Oltadır zaten Sistemi Anlamışsınızdır<br>• Komutlar : <br>!help - bu Sayfayı Açar<br>!lang - Dil Değiştirme Menusunu Açar<br>!bugfix - Bir buga girdiyseniz Bugtan Kurtarır",

parolavar="Parola Var",

oda1satin="Ev 1 - Satın Alındı !",

evegit="Eve Git",

sifreayar="Parola Ayarla Kaldır",

herksdvt="Herkesi Davet et",

kisidvt="Kişi Davet et",

davetmsg="seni eve Davet ediyor<br><br>Onaylamak İçin yeşil butona yani onaylaya iptal etmek içinse İptal tuşuna basınız.<br><br><br><VP><a href='event:ev1davetonay'>Onayla</a> <g>- <r><a href='event:ev1davetiptal'>İptal",

ziyaret="Ziyaret et",

lobidon="Lobiye Dön",

oda2satin="Ev 2 - Satın Alındı !",

oda3satin="Ev 3 - Satın Alındı !",

davetmsg2="seni eve Davet ediyor<br><br>Onaylamak İçin yeşil butona yani onaylaya iptal etmek içinse İptal tuşuna basınız.<br><br><br><VP><a href='event:ev2davetonay'>Onayla</a> <g>- <r><a href='event:ev2davetiptal'>İptal",

davetmsg3="seni eve Davet ediyor<br><br>Onaylamak İçin yeşil butona yani onaylaya iptal etmek içinse İptal tuşuna basınız.<br><br><br><VP><a href='event:ev3davetonay'>Onayla</a> <g>- <r><a href='event:ev3davetiptal'>İptal",

hosgeldin="<p align='center'>Hoşgeldin :)</p>",

ters1="Ters Balık Tutamazsın !",

ters2="Ters Maden Kazamazsın !"
...
ui.addTextArea(93, "<r><b><font size='9'>Bu Kodu Kullanmak İçin <j>[ "..math.floor(paragonder[name].obursure).." ] <r>Saniye Beklemelisiniz", name,  6, 24, nil, nil, 0x1, 0x1, 0.6, true)
...
ui.addPopup(0, 0, "Bunu Yapamazsın ! Yasak", name,274, 91, 200, true)
...
ui.addPopup(0, 0,"Odanın Sahibi : "..ev1sahib.."<br>Şifre Durumu : "..ev1parolas.."<br>Şifre : "..ev1parola.."<br>Satin Alinma Durumu : "..oda1alindi.."", name, 300, 174, 200, true)
...
ui.addPopup(0, 0, "Eğer bir bug yakaladıysanız<br>/c Muutluerkek bug buldum<br><br>You Found the Glitch ?<br>/c Muutluerkek im Found Glitch", name, 300, 174, 200, true)
...
ui.addPopup(0, 0, "Bütün Paranız : "..p[name].para.."<br>Para Göndermek İçin: (Not : Paranızın Yarısını Gönderebilirsiniz.)<br>!paragonder isim miktar", name, 300, 174, 400, true)
...
ui.addPopup(0, 0, "Hata : Şifre Girmedin !<br>Error : Password Box Empty !", name, 300, 174, 200, true)
...
ui.addTextArea(133, "<font size='15'><br><p align='center'><vp>"..ev1.."<bv><br>"..lang[name].davetmsg.."<br><br><br><VP><a href='event:ev1davetonay'>Onayla</a> <g>- <r><a href='event:ev1davetiptal'>İptal", cvp, 180, 116, 363, 204, 0x1, 0x1, 0.7,true)
...
ui.addTextArea(134, "<font size='15'><br><p align='center'><vp>"..ev1.."<bv><br>"..lang[name].davetmsg2.."<br><br><br><VP><a href='event:ev2davetonay'>Onayla</a> <g>- <r><a href='event:ev2davetiptal'>İptal", cvp, 180, 116, 363, 204, 0x1, 0x1, 0.7,true)
...
ui.addTextArea(136, "<font size='15'><br><p align='center'><vp>"..ev1.."<bv><br>"..lang[name].davetmsg3.."<br><br><br><VP><a href='event:ev1davetonay'>Onayla</a> <g>- <r><a href='event:ev1davetiptal'>İptal", cvp, 180, 116, 363, 204, 0x1, 0x1, 0.7,true)
