...
tfm.exec.setUIMapName("<J>DRAGYAĞMURU/<R>Drag Savaşı")ui.addTextArea(1,"<p align='center'><a href='event:profilsyh'><b><R></b></a></p>",name,50,10,350,20,1,true)

ui.addTextArea(3,"<p align='center'><a href='event:profil'><b><R></b>Night Club Football Özel/DRAGYAĞMURU</a></p>",name,60,20,330,20,10,true)



ui.addTextArea(1,"<p align='center'><a href='event:profilsyh'><b><R></b></a></p>",name,60,420,330,20,100,true)

ui.addTextArea(3,"<p align='center'><a href='event:profil'><b><R></b>Merhaba ! Minioyunuma Hoşgeldin</a></p>",name,60,420,330,20,100,true)

ui.addTextArea(0,"<p align='center'><a href='event:siyah'><b><R></b></a></p>",name,180,770,500,50,1,true)

ui.addTextArea(5,"<p align='center'><a href='event:nsl'><b><R></b>Nasıl Oynanır ?</a></p>",name,190,770,120,20,100,true)

ui.addTextArea(6,"<p align='center'><a href='event:kural'><b><R></b>Oyun Kuralları</a></p>",name,370,770,120,20,100,true)

ui.addTextArea(7,"<p align='center'><a href='event:krc'><b><R></b>MiniOyun Kurucuları</a></p>",name,550,770,120,20,100,true)
...
function eventTextAreaCallback(id, name, callback)
    ...
    if callback=="nsl" then
        ...
        ui.addTextArea(58,"Nasıl oynanılır:                          s",name,250,60,200,300,1,1,0.8,true)

        ui.addTextArea(7790,"<p align='center'><a href='event:nasılkpt'><b><R>X</b></a></p>",name,440,70,20,20,70,1,1,0.8,true)
    ...
    ui.addTextArea(7,"<p align='center'><a href='event:krc'><b><R></b>MiniOyun Kurucuları</a></p>",name,550,770,150,20,100,true)
    ...
    ui.removeTextArea(801,name)
        ...
        if callback=="right" then
                ...
                ui.addTextArea(510,"Bu Minioyun <VP><b>Space</b> <N>ve <VP><b>Eğilme</b><N> tuşları ile oynanır </p></p>",name,250,60,200,300,1,1,0.8,true)
    ...
    ui.removeTextArea(58,name)
        ...
        ui.removeTextArea(520,name)
         ...
         if callback=="left" then
                ...
                ui.addTextArea(520,"2. nasıl oynanılır",name,250,60,200,300,1,1,0.8,true)
    ...
    ui.addTextArea(8010,"<p align='center'><a href='event:left'><b><R>2</b></a></p>",name,440,170,20,20,70,1,1,0.8,true)
        ...
        ui.removeTextArea(510,name)
            ...
            if callback=="sonra" then
                ...
                ui.addTextArea(510,"Bu Minioyun  Kuralı üstten gelen <VP><b>Draglardan</b> kaçmak <N>ve <VP><b>Peyniri Alıp Yuvaya Girmektir</b>.<N></p></p>",name,250,60,200,300,1,1,0.8,true)
  ...
  ui.addTextArea(75,"<p align='center'>Bu kod <VP><b>Devilstrkpro</b><N> , <VP><b>Devilstrk</b> <N>ve <VP><b>Articguna</b><N> tarafından kodlanmıştır.</p>",name,480,450,300,150,1,1,0.8,true)
