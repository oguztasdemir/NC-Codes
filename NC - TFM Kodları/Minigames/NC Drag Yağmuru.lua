...
tfm.exec.setUIMapName("<ROSE>Bir sonraki oyunun başlamasına "..interval)
...
ui.addTextArea(4, "<VP><p align='center'><B>Amaç:</B>\n\n<CH><i>peyniri alıp draglardan kaçın!", nil, 290, 22, 180, nil, 0x000001, 0xCA0805, 0.8)
...
tfm.exec.setUIMapName("<J>DRAGYAĞMURU/<R>Drag Savaşı")

ui.addTextArea(4,"<p align='center'><a href='event:profilsyh'><b><R></b></a></p>",name,50,10,350,20,1,true)

ui.addTextArea(5,"<p align='center'><a href='event:profil'><b><R></b>Night Club Football Özel/DRAGYAĞMURU</a></p>",name,60,20,330,20,10,true)