...
lang.br = {
  ask_word = "Buraya Basýn",
  choose_word = "Aþaðýya bir þey yazýn: (2 ile 12 harf arasýnda)",
  more_players = "Deve ter no mínimo <font color='#FF0000'>2</font> jogadores para brincar de forca.",
  next_turn_1 = "Sýradaki tura ",
  next_turn_2 = " saniye(s).",
  turn_of_1 = "Yazýcý ",
  turn_of_2 = " ! ",
  patientez = "Onun yazdýðý yazýyý !harf yoluyla bulun",
  word_found = "Kazandý",
  word_not_found = "Bulamadýðýn yazý buydu ",
  time_out = "Yazý yazmana son 10 saniye",
...
tfm.exec.setUIMapName("<J>ADAM ASMACA/<R>Bulma Yarýþý/<J>Devilstrkpro")ui.addTextArea(1,"<p align='center'><a href='event:profilsyh'><b><R></b></a></p>",name,50,10,350,20,1,true)
