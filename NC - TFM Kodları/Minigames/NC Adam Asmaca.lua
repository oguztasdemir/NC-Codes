...
lang.br = {
  ...
  ask_word = "Buraya Basın",

  choose_word = "Aşağıya bir şey yazın: (2 ile 12 harf arasında)",

  more_players = "Deve ter no mínimo <font color='#FF0000'>2</font> jogadores para brincar de forca.",

  next_turn_1 = "Sıradaki tura ",

  next_turn_2 = " saniye(s).",

  turn_of_1 = "Yazıcı ",

  turn_of_2 = " ! ",

  patientez = "Onun yazdığı yazıyı !harf yoluyla bulun",

  word_found = "Kazandı",

  word_not_found = "Bulamadığın yazı buydu ",

  time_out = "Yazı yazmana son 10 saniye",

  pass_turn = "O mestre do jogo passou a vez !",

  quit = "O mestre do jogo saiu."
...
function eventLoop(currentTime, timeRemaining)
  ...
  if beginReset then
    ...
    if isTimeOut then ui.addTextArea(id["reset_timer_label"], "<p align='center'><BL>"..text.time_out.." <font color='#000000'>"..text.next_turn_1.."<font color='#FF0000'>"..math.floor(10 - resetTimer).."</font>"..text.next_turn_2.."</font></p>", nil, 25, 115, 750, 30, 0xC0C0C0, 0xC0C0C0, 0.0) end

    if hasWon then ui.addTextArea(id["reset_timer_label"], "<p align='center'><BL>"..text.word_found.." <font color='#000000'>"..text.next_turn_1.."<font color='#FF0000'>"..math.floor(10 - resetTimer).."</font>"..text.next_turn_2.."</font></p>", nil, 25, 115, 750, 30, 0xC0C0C0, 0xC0C0C0, 0.0) end

    if hasLost then ui.addTextArea(id["reset_timer_label"], "<p align='center'><font color='#000000'>"..text.word_not_found.."</font><BL>"..word:gsub("^%l", string.upper).."<font color='#000000'> ! "..text.next_turn_1.."<font color='#FF0000'>"..math.floor(10 - resetTimer).."</font>"..text.next_turn_2.."</font></p>", nil, 25, 115, 750, 30, 0xC0C0C0, 0xC0C0C0, 0.0) end

    if hasSkiped then ui.addTextArea(id["reset_timer_label"], "<p align='center'><BL>"..text.pass_turn.."<font color='#000000'> "..text.next_turn_1.."<font color='#FF0000'>"..math.floor(10 - resetTimer).."</font>"..text.next_turn_2.."</font></p>", nil, 25, 115, 750, 30, 0xC0C0C0, 0xC0C0C0, 0.0) end

    if hasQuit then ui.addTextArea(id["reset_timer_label"], "<p align='center'><BL>"..text.quit.."<font color='#000000'> "..text.next_turn_1.."<font color='#FF0000'>"..math.floor(10 - resetTimer).."</font>"..text.next_turn_2.."</font></p>", nil, 25, 115, 750, 30, 0xC0C0C0, 0xC0C0C0, 0.0) end
...
tfm.exec.setUIMapName("<J>ADAM ASMACA/<R>Bulma Yarışı/<J>Devilstrkpro")ui.addTextArea(1,"<p align='center'><a href='event:profilsyh'><b><R></b></a></p>",name,50,10,350,20,1,true)
