admins={["Devilstrkpro#5475"] = true, ["Devilstrk#5475"] = true, Fpkplaa=true}
...
bot = {
    ...
    help = "Hoşgeldiniz! TR serverinin tek botu olan GececiBot hizmetinizde!",

    lang = "TR",

    welcome = "kabilesine hoşgeldin !",

    survivor = "Survivor açılmıştır. Şamanlara dikkat edin ! İyi eğlenceler.",

    racing = "Racing'e hoşgeldiniz ! Hızlı olan kazansın. İyi eğlenceler.",

    defilante = "Defilante'ye hoşgeldiniz ! Bonusları doğru ve zamanında kullanın.",
...
function eventNewGame(playerList)
    ...
    if point==10 then
            ...
            ui.addTextArea(12,"<V>"..bot.name.."<N> artık <J>"..level..". <N>seviyede!",name,5,378,475,50,0x324650,0x4F6C7B,0.9,true)
...
function eventTextAreaCallback(id,name,callback)
    ...
    if callback=="isim" then
        ...
        ui.addTextArea(70,"<V><font size='13' face='soopafresh'><p align='center'>"..bot.name.."</p></font><br><N>Cins : "..cins.."<br><N>Kabile :<J> "..tfm.get.room.playerList[name].tribeName.."<br><N>Level :<J> "..level.."<br><N>Şuanki Ünvanı :<V> «"..bot.titles[1].."»<br><br><N>Şaman<br> <BL>• Peynir yüklü kurtarılan fare sayısı : "..saman.."<br> • Şahsen topladığı peynir : "..sahsen.."<br><br><N>Fare<br> <BL>• Topladığı peynir : "..peynir.. "<br><br><N>Sahip olduğu ünvanlar<br> • «"..bot.titles[1].."»<br> • «"..bot.titles[2].."»<br> • «"..bot.titles[5].."»",name,525,105,250,250,0x00001,0x000001,0.7,true)
    ...
    if callback=="boy" then
        ...
        ui.updateTextArea(70,"<V><p align='center'>"..bot.name.."</p><br><N>Cins : "..cins.."<br><N>Kabile :<J> "..tfm.get.room.playerList[name].tribeName.."<br><N>Level :<J> "..level.."<br><N>Şuanki Ünvanı :<V> «"..bot.titles[1].."»<br><br><N>Şaman<br> <BL>• Peynir yüklü kurtarılan fare sayısı : "..saman.."<br> • Şahsen topladığı peynir : "..sahsen.."<br><br><N>Fare<br> <BL>• Topladığı peynir : "..peynir.. "<br><br><N>Sahip olduğu ünvanlar<br> • «"..bot.titles[1].."»<br> • «"..bot.titles[2].."»<br> • «"..bot.titles[3].."»",playerList,525,125,1000,00,0x00001,0x000001,0.7,true)
    ...
    if callback=="girl" then
        ...
        ui.updateTextArea(70,"<V><p align='center'>"..bot.name.."</p><br><N>Cins : "..cins.."<br><N>Kabile :<J> "..tfm.get.room.playerList[name].tribeName.."<br><N>Level :<J> "..level.."<br><N>Şuanki Ünvanı :<V> «"..bot.titles[1].."»<br><br><N>Şaman<br> <BL>• Peynir yüklü kurtarılan fare sayısı : "..saman.."<br> • Şahsen topladığı peynir : "..sahsen.."<br><br><N>Fare<br> <BL>• Topladığı peynir : "..peynir.. "<br><br><N>Sahip olduğu ünvanlar<br> • «"..bot.titles[1].."»<br> • «"..bot.titles[2].."»<br> • «"..bot.titles[3].."»",playerList,525,125,250,225,0x00001,0x000001,0.7,true)
    ...
    if callback=="isim" then
        ...
        ui.addTextArea(68,"<a href='event:emote'>İfadeler</a>",name,150,60,75,20,0x00001,0x000001,0.5,true)

        ui.addTextArea(67,"<a href='event:game'>Oyunlar</a>",name,150,25,75,20,0x00001,0x000001,0.5,true)

        ui.addTextArea(76,"<V><font size='15' face='soopafresh'><p align='center'>"..bot.name.."</p></font><br><N>Bot Cinsiyeti = <ROSE><a href='event:girl'>Kadın +</a> <CH><a href='event:boy'>Erkek ></a><br><VP>Bot Ünvanı : <BV> <a href='event:1'>«" .. bot.titles[1] .. "»</a> <a href='event:2'>«" .. bot.titles[2] .. "»</a> <a href='event:3'>«" .. bot.titles[3] .. "»</a> <R><a href='event:özel'>Ünvanı Kendin Seç</a><br><N>"..bot.name.."'u konuşturmak için <J> !b [mesaj] <N>komutunu kullanabilirsiniz.<br><a href='event:party'><J>Party <VP>Mod</a> <a href='event:snowy'><N>Snowy Mod</a><br><R><p align='center'><a href='event:tkapat'>[KAPAT]</a></p>",name,250,25,300,120,0x00001,0x000001,0.5,true)

    end

    if callback=="emote" then

        ui.addTextArea(76,"<V><font size='15' face='soopafresh'><p align='center'>"..bot.name.."</p></font><br><BV>• <N><a href='event:gaz'>Gaz Çıkar</a><br><BV>• <N><a href='event:kalp'>Kalp At</a><br><R><p align='center'><a href='event:tkapat'>[KAPAT]</a></p>",name,250,25,300,110,0x00001,0x000001,0.5,true)
  ...
  ui.addTextArea(0, "Gece", nil, -400, -400, 4000, 4000, 0x000000, 0x33cc00, 0.6)
    ...
    if callback=="özel" then
        ...
        ui.addPopup(1,2,"<font color='#2ecf73'>"..bot.name.."</font><font color='#ddffdd'>'un Ünvanını Seç</font>",name,250,130,300)
...
if admins[name] then
        ...
        ui.addTextArea(76,"<V><font size='15' face='soopafresh'><p align='center'>"..bot.name.."</p></font><br><N>Bot Cinsiyeti = <ROSE><a href='event:girl'>Kadın +</a> <CH><a href='event:boy'>Erkek ></a><br><VP>Bot Ünvanı : <BV> <a href='event:1'>«" .. bot.titles[1] .. "»</a> <a href='event:2'>«" .. bot.titles[2] .. "»</a> <a href='event:3'>«" .. bot.titles[3] .. "»</a> <R><a href='event:özel'>Ünvanı Kendin Seç</a><br><N>"..bot.name.."'u konuşturmak için <J> !b [mesaj] <N>komutunu kullanabilirsiniz.<br><a href='event:party'><J>Party <VP>Mod</a> <a href='event:karanlık'><N>Snowy Mod</a><br><R><p align='center'><a href='event:tkapat'>[KAPAT]</a></p>",name,250,25,300,120,0x00001,0x000001,0.5,true)
