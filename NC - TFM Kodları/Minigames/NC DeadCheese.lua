...
tfm.exec.setUIMapName("<J>ÖLDÜREN PEYNİR/<R>SP Savaşı")

ui.addTextArea(1,"<p align='center'><a href='event:profilsyh'><b><R></b></a></p>",name,50,10,350,20,1,true)

ui.addTextArea(3,"<p align='center'><a href='event:profil'><b><R></b>Yapan:Devilstrkpro-DEVİLSTRK/ÖLDÜREN PEYNİR</a></p>",name,60,20,330,00,10,true)