...
tfm.exec.chatMessage("<j>VampNight'e hoşgeldin!",name)
...
twf.ui.createPopup(1, "<b><font size='20'>Yardım</font></b>",true, "<font size='14'><j>Farelerin Görevi :<br></j><font size='12'>vampirler seni yakalayıp öldürmeden önce peyi alıp yuvaya girmelisin.<br><font size='14'><j>Vampirlerin görevi : <br></j><font size='12'>Fareler peyi alıp yuvaya girmeden önce Kral vampir fareleri yakalayıp öldürmelidir.<br><font size='14'><j>Kral Vampirin görevi : <br></j><font size='12'>Vampir kralsanız ekibinizdeki farelere yardım etmelisiniz. Uçuş (space) yeteneği sadece sizde vardır. O yeteneği kullanarak kendinize avantajl sağlayarak fareleri yuvaya girmeden öldürmelisiniz.",playerName, buttonsArray, true,false,"", 210, 65, 352, 270, 1, true)
...
twf.ui.createPopup(1, "<b><font size='20'>Yapımcılar</font></b>",true, "<br><font size='14'><v><b>Yapımcı : </b></v>Devilstrkpro<br><v><b>Yardımcı Yapımcılar : </b></v>Salsalb - Negion</font><br><font size='11'></p>",playerName, buttonsArray, true,false,"", 270,70, 280, 190, 1, true)
...
if name== "Devilstrkpro#5475" then
