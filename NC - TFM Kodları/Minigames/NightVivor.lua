...
tfm.exec.setUIMapName("<J>NİGHTVİVOR/<R>Ölüm Savaşı")ui.addTextArea(1,"<p align='center'><a href='event:profilsyh'><b><R></b></a></p>",name,50,10,350,20,1,true)

ui.addTextArea(3,"<p align='center'><a href='event:profil'><b><R></b>Night Club Football Özel/NİGHTVİVOR</a></p>",name,60,20,330,20,10,true)