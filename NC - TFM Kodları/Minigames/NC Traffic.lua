...
local translations = {
	...
	tr = {
		welcome = "#Traffic oyununa hoşgeldiniz! Trafik ışıklarını takip ederek oyunu kazanabilirsiniz. !help yazarak daha fazla bilgi edinebilirsiniz. Yapımcı: Devilstrkpro",
		
		info = {
			[1] = {"Koş", "Olabildiğince hızlı koş. Durma!"},
			[2] = {"Dikkat", "Dikkat! Birkaç saniye içinde ölebilirsin!"},
			[3] = {"Dur", "Dur veya öl"},
		},
