...
function eventNewGame()
  ...
  ui.addTextArea(1, "<p align='center'><vp>[Boşluk]", nil, 20, 220, 120, 30, 0, 0, 0, true)

  ui.addTextArea(2, "<p align='center'><vp>[Boşluk]", nil, 660, 220, 120, 30, 0, 0, 0, true)
...
function verificaVitoria(p)
  ...
  if p1 and p2 then
    ...
    ui.addTextArea(4, string.format("<p align='center'><font color='#ffffff' size='60px'>%s kazandı!", jogador[p]), nil, 0, 120, 800, 400, 0, 0, 0, true)
