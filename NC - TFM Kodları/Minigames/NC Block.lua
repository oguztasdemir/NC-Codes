...
setMapTitle("Press the spacebar to get a bonus or to respawn!")
generateMap()
managePlayers()
newBonus()
loading = true
...
bonus[2]["title"] = "Spawn the Trampolines."
...
bonus[3] = {}
bonus[3]["name"] = "Lava"
bonus[3]["title"] = "Turn platforms into lava. "
...
bonus[4]["title"] = "Fertilize platforms."
...
bonus[5] = {}
bonus[5]["name"] = "Wind"
bonus[5]["title"] = "Blow on platforms."
bonus[5]["particles"] = 1
bonus[5]["speed"] = false
bonus[5]["id"] = 10
...
setMapTitle("A new game is about to start.")
...
if timer < 5 then
setMapTitle("A new game will start in " .. math.ceil(timer) .. " second...")
end
timer = timer - 0.5
end
end
...
setMapTitle(playerName .. " Won in " .. timeElapsed/100 .. " second.")
gameEnded = true
end
end
