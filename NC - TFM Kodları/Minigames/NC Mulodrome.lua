print("<vp><br>Taring Oyununa Hoş Geldiniz<br><j>Destek =><ROSE> http://www.transformice.com/forum/?s=733766&p=0</ROSE>")
...
function eventNewGame()
        ...
        if start == 1 then
                ...
                ui.updateTextArea(0, "Puan durumu: <font color=\"#0000FF\">"..scoreBlue.." puan ile mavi takım</font> ve <font color=\"#FF0000\">"..scoreRed.." ile kırmızı takım</font>!")
...
function eventNewPlayer(name)
        ...
        if #teamBlue > #teamRed then
                ...
                ui.updateTextArea(0, name.." a oyuna katıldı <font color=\"#FF0000\">Kırmızı takım</font>!")
                ...
                ui.updateTextArea(0, name.." oyuna katıldı <font color=\"#0000FF\">Mavi takım</font>!")
...
function eventLoop(currentTime, timeRemaining)
        ...
        if start == 0 then
                ...
                ui.updateTextArea(10, "     Başlamasına "..(timeRemaining/1000-(timeRemaining%1000)/1000).." saniye kaldı!")
...
function givingPointBis(name, team)
        ...
        if nbWon == 1 then
                ...
                if team == "blue" then
                        ...
                        ui.updateTextArea(0, name.." yi tebrik ederiz <font color=\"#0000FF\">mavi</font> takım 4 puan kazandı.")

                        scoreBlue = scoreBlue + 4

                else

                        ui.updateTextArea(0, name.." yi tebrik ederiz <font color=\"#FF0000\">Kızmızı</font> takım 4 puan kazandı.")
        ...
        elseif nbWon == 2 then
                ...
                if team == "blue" then
                        ...
                        ui.updateTextArea(0, name.." yi tebrik ederiz <font color=\"#0000FF\">Mavi</font> takım 2 puan kazandı.")

                        scoreBlue = scoreBlue + 2

                else

                        ui.updateTextArea(0, name.." yi tebrik ederiz <font color=\"#FF0000\">Kırmızı</font> takım 2 puan kazandı.")
        ...
        elseif nbWon == 3 then
                ...
                if team == "blue" then
                        ...
                        ui.updateTextArea(0, name.." yi tebrik ederiz <font color=\"#0000FF\">Mavi</font> takım 1 puan kazandı.")

                        scoreBlue = scoreBlue + 1

                else

                        ui.updateTextArea(0, name.." yi tebrik ederiz <font color=\"#FF0000\">Kırmızı</font> takım 1 puan kazandı.")
...
function displayTeam()
        ...
        ui.updateTextArea(20, "Oyuncular ve Takımları:<br><font color=\"#003AFF\">Mavi: </font>"..stringBlue.."<br><font color=\"#FF0000\">Kızmızı: </font>"..stringRed)
...
function displayVictory()
        ...
        if scoreBlue > scoreRed then
                ...
                ui.updateTextArea(0, "           Tebrik ederiz <font color=\"#0000FF\">Mavi</font> takım oyunu kazandı.")

        elseif scoreRed > scoreBlue then

                winner = "rouge"

                ui.updateTextArea(0, "           Tebrik ederiz <font color=\"#FF0000\">Kırmızı</font> takım oyunu kazandı.")

        else

                winner = ""

                ui.updateTextArea(0, "           <font color=\"#FFFF00\">             Dostluk kazandı. </font> kazanamdı.")
...
function initTeam()
        ...
        ui.addTextArea(0, "                                          Takımlar!", nil, 200, 30, 400, 20, 0x101010, 0x000000, 0.7, true)
...
ui.addTextArea(999, "<ROSE><B>                   Taring Oyununa Hoş Geldiniz </B> </ROSE> <BR><V>Amaç</V> <J>• <T>Puan toplayarak takımınıza oyun kazandırmak.</T></J></br> <br><V>Kurallar ve Özellikler</V><J> • <T>1. girene 4 puan, 2. girene 3 puan, 3. girene 2 puan takımına gelmektedir.</T> </J><br> <J>• <T>4 ve sonrasına puan eklenmemektedir.<br><T><J><br><V>Komutlar</V><J><J>• <T>!öl<R> = <J><T>kendinizi öldürmek </T></T></J> </R> <br><V>Yönetici</V><J><J>• <T>Noktats </T></J>", "Noktats", 225, 100, 350, 220, 1, 1, 0.8)
